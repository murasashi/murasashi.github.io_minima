...
### Example 01--Sub-Gaussian distribution.
For example, the sub-Gaussian is

$$
\ln E[\exp(\lambda [X-E[X]))] \le \sigma^2 \frac{\lambda}{2}.
$$

### Example 02 -- Sub-Exponential distribution.
